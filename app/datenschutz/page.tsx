...
export const metadata: Metadata = {
  title: "Datenschutzerklärung - Instagram Schrift Generator",
  description:
    "Datenschutzerklärung für instagramschriftgenerator.pro. Erfahre, wie wir deine Daten beim Nutzen unseres Instagram Schrift Generators schützen.",
  robots: {
    index: false,
    follow: false,
  },
...
export default function DatenschutzPage() {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold text-slate-800 dark:text-slate-100 mb-8">Datenschutzerklärung</h1>
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        ...
        <p>
          ...
          passiert, wenn Sie unseren Instagram Schrift Generator auf instagramschriftgenerator.pro besuchen.
        ...
        <p>
          Wenn Sie unseren Instagram Schrift Generator nutzen, werden verschiedene personenbezogene Daten erhoben.
        ...
        <p>
          Unser Instagram Schrift Generator verwendet den lokalen Speicher Ihres Browsers (localStorage), um Ihre
          Präferenzen zu speichern, wie z.B.:
        </p>
        <ul>
          <li>Farbschema-Einstellungen (hell/dunkel)</li>
          <li>Favorisierte Instagram Schriftarten</li>
          <li>Zuletzt verwendete Texte (nur lokal gespeichert)</li>
        </ul>

        <p>
          Diese Daten werden ausschließlich lokal auf Ihrem Gerät gespeichert und nicht an unsere Server übertragen. Sie
          können diese Daten jederzeit durch das Löschen Ihrer Browser-Daten entfernen.
        </p>
        ...
        <p>
          Derzeit verwenden wir keine Analyse-Tools oder Werbung auf unserer Website. Sollte sich dies in Zukunft
          ändern, werden wir diese Datenschutzerklärung entsprechend aktualisieren und Sie darüber informieren.
        </p>

        <h2>8. Besonderheiten unseres Instagram Schrift Generators</h2>
        <p>
          Unser Instagram Schrift Generator funktioniert vollständig in Ihrem Browser. Die von Ihnen eingegebenen Texte
          werden nicht an unsere Server gesendet oder gespeichert. Alle Umwandlungen in Instagram Schriftarten erfolgen
          lokal auf Ihrem Gerät mittels JavaScript und Unicode-Zeichen.
        </p>

        <p>
          Wenn Sie die Kopierfunktion verwenden, wird der Text in die Zwischenablage Ihres Geräts kopiert. Wir haben
        ...
        <h2>10. Kontakt</h2>
        <p>
          Bei Fragen zum Datenschutz oder zur Verarbeitung Ihrer personenbezogenen Daten im Zusammenhang mit unserem
